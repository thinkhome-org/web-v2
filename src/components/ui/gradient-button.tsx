...
export function GradientButton({
  ...
  return (
    <Component
      ...
      {...props}
    >
      <div className="absolute inset-0 rounded-md bg-gradient-to-r from-accent to-red-400 opacity-0 group-hover/btn:opacity-100 blur transition duration-500" />
      <div className="absolute inset-0 rounded-md bg-gradient-to-r from-accent to-red-400 opacity-0 group-hover/btn:opacity-100 transition duration-500" />
      <span
        className={cn(
