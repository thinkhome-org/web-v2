        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <div className="px-4 py-2 backdrop-blur-md bg-white/5 border border-white/20 rounded-full text-sm text-white/80">
                ✓ 24/7 podpora
              </div>
              <div className="px-4 py-2 backdrop-blur-md bg-white/5 border border-white/20 rounded-full text-sm text-white/80">
                ✓ Pevné ceny
            ...
            <Card className="backdrop-blur-md bg-gradient-to-r from-accent/10 to-accent/5 border border-accent/30">
              <CardContent className="pt-8 pb-8">
                ...
                <p className="text-white/80 mb-6 max-w-2xl mx-auto">
                  Rádi s vámi projdeme vaše potřeby a navrhneme optimální řešení. 
